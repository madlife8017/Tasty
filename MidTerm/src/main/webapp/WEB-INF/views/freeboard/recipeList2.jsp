	...
	<div id="main-con">
		...
		<div id="main">
			...
			<div class="boxbox" data-bs-toggle="modal" data-bs-target="#myModal">
				<img src="${pageContext.request.contextPath}/user/display/${login.fileLoca}>
				/${login.fileName}" alt="default" id="article-img" data-userid="${login.userId}"
					data-fanum="<%=articles.get(i).getBno()%>">
			</div>
